const creeareTabelUser= "create table USERS (numeUtilizator string primary key , nume String not null, mail String not null, parola String not null, numarTelefon string not null)";
